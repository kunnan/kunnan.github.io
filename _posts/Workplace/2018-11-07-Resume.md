...
-  ![image](https://img-blog.csdnimg.cn/20190521112548162.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEwMTg5Nzk=,size_16,color_FFFFFF,t_70)
...
* 负责qct app的开发：新增注册模块、防止crash框架；适配最新系统API，提高app整体的操作流畅度和UI用户体验;负责蓝牙标签打印、票据打印模块； 负责开单、收款模块。
* 负责CRM app的框架搭建、公海商户模块、待办事项模块。
...
>   - 关于设备ID的心得： 逆向研究一些app的设备ID以及OpenUDID都是基于CFUUIDCreate、CFUUIDCreateString 进行创建
...
- [充满激情的iOS逆向与安全工程师、高级iOS工程师](https://about.me/kunnan)
  ...
  - 3 [实时更新的简历](https://kunnan.github.io/2018/11/07/Resume/)、[整体的附件简历]( https://kunnan.github.io/resume/2018-11-07-Resume.pdf) 
