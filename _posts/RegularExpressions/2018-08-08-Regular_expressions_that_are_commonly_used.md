...
> * **[谓词（NSPredicate）创建正则表达式**](https://kunnan.github.io/2018/05/14/NSPredicate/)

> * **NSString实例方法**: 使用rangeOfString:options:
>
> * [**NSRegularExpression类创建正则表达式: **使用正则来过滤并获取我们想要的特定部分](https://kunnan.github.io/2018/06/24/stringByReplacingOccurrencesOfString_substringWithRange_NSRegularExpression/)
>
...
>     ```
>
>   * 当一个字符串有多个符合特定规则的字符，我们可以分别获取到符合特定规则的字符： matchesInString:str
>
>     ```
>     NSString *regex = @"\\-\\d*\\.";
...
> * 判断用户输入的字符是否合法: **NSPredicate**
>
>   
>
> * 捕获用户输入的特定内容 NSRegularExpression
>
>   * 如果是可能有多个捕获结果，那么可以使用
>
>     方法matchesInString:str，否则使用方法firstMatchInString:url
